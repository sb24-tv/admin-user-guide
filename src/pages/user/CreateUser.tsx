...
function CreateUser(props: MyComponentProps) {
    ...
    const handleSubmit = async () => {
        ...
        // console.log("this  handleSubmit  data.activate:", data.activate)
        // return
        // useEffect(() => {
    ...
    return (
        <Transition appear show={show} as={Fragment}>
            <Dialog as="div" className="relative z-999" onClose={onCloseCreateUser}>
                <Transition.Child
                    as={Fragment}
                                ...
                                <div className="rounded-sm dark:border-strokedark dark:bg-boxdark">
                                    <div className="flex flex-col gap-5.5 p-6.5">
                                        ...
                                        <div className="flex justify-end items-center">
                                            <button className="flex justify-center bg-transparent border border-meta-9 px-8 py-2 rounded-md font-medium text-black dark:text-white mr-3.5" onClick={onCloseCreateUser}>
                                                Cancel
                                            </button>
