    ...
    <>
      ...
      <div className="relative">
        ...
        <div
          ...
          className={`absolute right-0 mt-5 flex w-62.5 flex-col rounded-xl bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${dropdownOpen === true ? 'block' : 'hidden'
            }`}
        >
